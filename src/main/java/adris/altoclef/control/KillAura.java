        ...
        if (!invStacks.isEmpty()) {
            ...
            for (ItemStack invStack : invStacks) {
                if (invStack.getItem() instanceof SwordItem item) {
                    ...
                    String swordName = item.getTranslationKey().toLowerCase();  // Assuming the translation key is used for the name
                    ...
                    if (handItem instanceof SwordItem handToolItem) {
                        String handSwordName = handToolItem.getTranslationKey().toLowerCase();
