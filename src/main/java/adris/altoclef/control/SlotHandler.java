...
public class SlotHandler {
    ...
    public boolean forceDeequipHitTool() {
        return forceDeequip(stack -> stack.getItem() instanceof ShovelItem ||
                Registries.ITEM.getEntry(stack.getItem()).isIn(ItemTags.MINING_ENCHANTABLE) ||
    ...
    public void forceDeequipRightClickableItem() {
        forceDeequip(stack -> {
                    ...
                    return item instanceof BucketItem // water, lava, milk, fishes
                            ...
                            || item == Items.LEAD
                            || item == Items.SHIELD
                            || Registries.ITEM.getEntry(stack.getItem()).isIn(ItemTags.MINING_ENCHANTABLE);  // Armor items that can be right-clicked or equipped
                }
        );
    }
