...
public class InventorySubTracker extends Tracker {
    ...
    public List<ItemStack> getInventoryStacks(boolean includeCursor) {
        ...
        // Armor slots
        result.add(inv.getStack(PlayerSlot.ARMOR_BOOTS_SLOT.getInventorySlot()));
        result.add(inv.getStack(PlayerSlot.ARMOR_LEGGINGS_SLOT.getInventorySlot()));
        result.add(inv.getStack(PlayerSlot.ARMOR_CHESTPLATE_SLOT.getInventorySlot()));
        result.add(inv.getStack(PlayerSlot.ARMOR_HELMET_SLOT.getInventorySlot()));

        // Offhand
        result.add(inv.getStack(PlayerSlot.OFFHAND_SLOT.getInventorySlot()));
