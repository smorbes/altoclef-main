        ...
        if (!invStacks.isEmpty()) {
            ...
            for (ItemStack invStack : invStacks) {
                if (invStack.getItem() instanceof SwordItem item) {
                    float itemDamage = SwordDamageUtility.getSwordDamage(item.getName().getString().toLowerCase());
                    ...
                    if (handItem instanceof SwordItem handToolItem) {
                        handDamage = SwordDamageUtility.getSwordDamage(handToolItem.getName().getString().toLowerCase());
                    }
