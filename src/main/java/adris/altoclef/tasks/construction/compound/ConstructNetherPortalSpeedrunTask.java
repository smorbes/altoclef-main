...
public class ConstructNetherPortalSpeedrunTask extends adris.altoclef.tasksystem.Task {
    ...
    private static final LavaTarget[] PORTAL_FRAME_LAVA = new LavaTarget[]{
            // Left side
            new LavaTarget(0, 0, -1, Direction.fromVector(new Vec3i(-1, 0, 0), Direction.NORTH)),
            new LavaTarget(0, 1, -1, Direction.fromVector(new Vec3i(-1, 0, 0), Direction.NORTH)),
            new LavaTarget(0, 2, -1, Direction.fromVector(new Vec3i(0, 1, 0), Direction.NORTH)),
            // Right side
            new LavaTarget(0, 0, 2, Direction.fromVector(new Vec3i(-1, 0, 0), Direction.SOUTH)),
            new LavaTarget(0, 1, 2, Direction.fromVector(new Vec3i(0, 1, 0), Direction.SOUTH)),
            new LavaTarget(0, 2, 2, Direction.fromVector(new Vec3i(0, 1, 0), Direction.SOUTH)),
            // Bottom
            new LavaTarget(0, -1, 0, Direction.fromVector(new Vec3i(0, 1, 0), Direction.DOWN)),
            new LavaTarget(0, -1, 1, Direction.fromVector(new Vec3i(0, 1, 0), Direction.DOWN)),
            // Top
            new LavaTarget(0, 3, 0, Direction.fromVector(new Vec3i(0, 0, 1), Direction.UP)),
            new LavaTarget(0, 3, 1, Direction.fromVector(new Vec3i(0, 0, 1), Direction.UP))
    };
