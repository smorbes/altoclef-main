...
public class ItemHelper {
    ...
    private static Map<Item, Integer> _fuelTimeMap = new HashMap<>();
    ...
    public static boolean isOfBlockType(Block b, TagKey<Block> tag) {
        // Get the block's registry key
        var blockKey = Registries.BLOCK.getKey(b);

        // Check if the block's registry key equals the tag's identifier
        return blockKey.map(key -> key.equals(tag.id())).orElse(false);
    }
    ...
    private static Map<Item, Integer> getFuelTimeMap() {
        _fuelTimeMap = new HashMap<>();
        _fuelTimeMap.put(Items.COAL, 1600);            // Coal burns for 1600 ticks
        _fuelTimeMap.put(Items.LAVA_BUCKET, 20000);    // Lava Bucket burns for 20000 ticks
        _fuelTimeMap.put(Items.OAK_PLANKS, 300);       // Oak Planks burns for 300 ticks
        _fuelTimeMap.put(Items.BLAZE_POWDER, 2400);    // Blaze Powder burns for 2400 ticks
        _fuelTimeMap.put(Items.COAL_BLOCK, 16000);     // Coal Block burns for 16000 ticks
        _fuelTimeMap.put(Items.CHARCOAL, 1600);        // Charcoal burns for 1600 ticks
        _fuelTimeMap.put(Items.BOOKSHELF, 300);        // Bookshelf burns for 300 ticks
        _fuelTimeMap.put(Items.STICK, 100);            // Stick burns for 100 ticks
        _fuelTimeMap.put(Items.WOODEN_SWORD, 200);     // Wooden Sword burns for 200 ticks
        _fuelTimeMap.put(Items.WOODEN_SHOVEL, 200);    // Wooden Shovel burns for 200 ticks
        _fuelTimeMap.put(Items.WOODEN_PICKAXE, 200);   // Wooden Pickaxe burns for 200 ticks
        _fuelTimeMap.put(Items.WOODEN_AXE, 200);       // Wooden Axe burns for 200 ticks
        _fuelTimeMap.put(Items.WOODEN_HOE, 200);       // Wooden Hoe burns for 200 ticks
        _fuelTimeMap.put(Items.OAK_LOG, 300);          // Oak Log burns for 300 ticks
        _fuelTimeMap.put(Items.OAK_WOOD, 300);         // Oak Wood burns for 300 ticks
        _fuelTimeMap.put(Items.BIRCH_LOG, 300);        // Birch Log burns for 300 ticks
        _fuelTimeMap.put(Items.BIRCH_WOOD, 300);       // Birch Wood burns for 300 ticks
        _fuelTimeMap.put(Items.SPRUCE_LOG, 300);       // Spruce Log burns for 300 ticks
        _fuelTimeMap.put(Items.SPRUCE_WOOD, 300);      // Spruce Wood burns for 300 ticks
        _fuelTimeMap.put(Items.DARK_OAK_LOG, 300);     // Dark Oak Log burns for 300 ticks
        _fuelTimeMap.put(Items.DARK_OAK_WOOD, 300);    // Dark Oak Wood burns for 300 ticks
        _fuelTimeMap.put(Items.JUNGLE_LOG, 300);       // Jungle Log burns for 300 ticks
        _fuelTimeMap.put(Items.JUNGLE_WOOD, 300);      // Jungle Wood burns for 300 ticks
        _fuelTimeMap.put(Items.ACACIA_LOG, 300);       // Acacia Log burns for 300 ticks
        _fuelTimeMap.put(Items.ACACIA_WOOD, 300);      // Acacia Wood burns for 300 ticks
        _fuelTimeMap.put(Items.COBBLESTONE, 0);        // Cobblestone cannot be used as fuel
        _fuelTimeMap.put(Items.BLAZE_ROD, 2400);       // Blaze Rod burns for 2400 ticks
        _fuelTimeMap.put(Items.BOOK, 300);             // Book burns for 300 ticks
        _fuelTimeMap.put(Items.BIRCH_PLANKS, 300);     // Birch Planks burns for 300 ticks
        _fuelTimeMap.put(Items.CHEST, 300);            // Chest burns for 300 ticks
        _fuelTimeMap.put(Items.CRAFTING_TABLE, 300);   // Crafting Table burns for 300 ticks
        _fuelTimeMap.put(Items.HAY_BLOCK, 1600);       // Hay Block burns for 1600 ticks
        _fuelTimeMap.put(Items.LADDER, 300);           // Ladder burns for 300 ticks
        _fuelTimeMap.put(Items.PUMPKIN, 300);          // Pumpkin burns for 300 ticks
        _fuelTimeMap.put(Items.BAMBOO, 50);            // Bamboo burns for 50 ticks
        _fuelTimeMap.put(Items.KELP, 200);             // Kelp burns for 200 ticks
        _fuelTimeMap.put(Items.CACTUS, 200);           // Cactus burns for 200 ticks

        // Add any other fuels you may have
        return _fuelTimeMap;
    }
